Feature: Server
  ...
  Scenario: New Page
    Given a nested populated app
    When I GET the "/posts/1/comments/new" page
    Then I should see an html page

  Scenario: Create Post
    Given a nested populated app
    When I POST to "/posts/1/comments"
    Then I should be redirected to an html page

  Scenario: Show Page
    Given a nested populated app
    When I GET the "/posts/1/comments/1" page
    Then I should see an html page

  Scenario: Edit Page
    Given a nested populated app
    When I GET the "/posts/1/comments/1/edit" page
    Then I should see an html page

  Scenario: Update Post
    Given a nested populated app
    When I PUT to "/posts/1/comments/1"
    Then I should be redirected to an html page

  Scenario: Destroy Post
    Given a nested populated app
    When I DELETE to "/posts/1/comments/1"
    Then I should be redirected to an html page